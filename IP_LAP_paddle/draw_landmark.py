...
pose_landmark_idx = summary_landmark(FACEMESH_NOSE.union(*[
...
def draw_landmarks(image: np.ndarray, landmark_list: List, connections:
    Optional[List[Tuple[int, int]]]=None, landmark_drawing_spec: Union[
    DrawingSpec, Mapping[int, DrawingSpec]]=DrawingSpec(color=RED_COLOR),
    connection_drawing_spec: Union[DrawingSpec, Mapping[Tuple[int, int],
